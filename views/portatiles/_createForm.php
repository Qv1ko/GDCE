...
<div class="portatiles-form">
    <?php $form = ActiveForm::begin(['enableAjaxValidation' => true]); ?>
        ...
        <div class="row">
            <!-- Campo para seleccionar el tipo de almacenamiento del portátil -->
            <div class="col-md-6">
                <?= $form->field($model, 'dispositivo_almacenamiento')->label($model->getAttributeLabel('dispositivo_almacenamiento'))->dropDownList(['HDD' => 'Dispositivo HDD', 'SSD' => 'Dispositivo SSD'], ['prompt' => 'Selecciona un dispositivo']) ?>
            </div>
            <!-- Campo para la capacidad de almacenamiento del portátil -->
            <div class="col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <?= $form->field($model, 'estado')->label($model->getAttributeLabel('estado'))->dropDownList(['Disponible' => 'Disponible', 'Averiado' => 'Averiado'], ['prompt' => 'Selecciona un estado']) ?>
            </div>

            <!-- Campo para seleccionar el cargador del portátil -->
            <div class="col-md-4">
                <label class="control-label">Cargador</label>
                <?= Html::dropDownList('cargador', null, Cargadores::getCargadoresLibres(), ['prompt' => 'Selecciona un cargador', 'class' => 'form-control']) ?>
            </div>

            <!-- Campo para seleccionar el almacén del portátil -->
            <div class="col-md-4">
                <?= $form->field($model, 'id_almacen')->dropDownList(Almacenes::getAlmacenesDisponibles(), ['prompt' => 'Selecciona un almacén']) ?>
            </div>
