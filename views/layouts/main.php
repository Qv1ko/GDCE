...
<html lang="<?= Yii::$app->language ?>" class="h-100">
    ...
    <footer class="footer mt-auto py-3 text-muted" style="text-align: center;">
        <div class="container">
            <div class="flex-grow-1">
                <p style="color: #E3E3E3;">Desarrollado por <span style="color: #82C0CC">Víctor García Murillo</span></p>
            </div>
            <div class="flex-shrink-0">
                <a class="footer-icon" href="https://github.com/Qv1ko/GDCE" target="_blank">
                ...
                <a class="footer-icon" href="https://gitlab.com/vgarcia3301646/gdce" target="_blank">
                    <svg class="button-icon" xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 512 512">
    ...
    <style>
        ...
        .footer .container > div {
            flex-basis: 48%; /* Ajusta el valor según sea necesario para dejar espacio para el margen entre los elementos */
        }
