...
<html lang="<?= Yii::$app->language ?>" class="h-100">
    ...
    <footer class="footer mt-auto py-3 text-muted">
        <div class="container">
            <p class="float-left">Desarrollado por <span style="color: #99FF33">Víctor García Murillo</span></p>
            <a class="float-right footer-icon" href="https://github.com/Qv1ko/GDCE" target="_blank">
                <svg class="github-icon" xmlns="http://www.w3.org/2000/svg" height="32" width="32" viewBox="0 0 512 512">
            ...
            <a class="float-right footer-icon" href="https://gitlab.com/vgarcia3301646/gdce" target="_blank">
                <svg class="gitlab-icon" xmlns="http://www.w3.org/2000/svg" height="32" width="32" viewBox="0 0 512 512">
