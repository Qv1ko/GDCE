...
<html lang="<?= Yii::$app->language ?>" class="h-100">
    ...
    <footer class="footer mt-auto py-3 text-muted d-flex align-items-center justify-content-between">
        <div class="container">
            <p class="float-left" style="color: #E3E3E3;">Desarrollado por <span style="color: #82C0CC">Víctor García Murillo</span></p>
            <div>
