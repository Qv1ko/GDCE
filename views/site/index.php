    ...
    <div class="row d-flex justify-content-center">
        ...
        <div class="col-md-2 col-sd-3 col-6">
            ...
            <div class="input-group">
                ...
                <!-- Crear un campo de entrada para el código QR o código de portátil -->
                <input type="text" id="searchInput" class="form-control" placeholder="(ej. 123A)">

                <!-- Crear un botón para el grupo de entrada -->
                <div class="input-group-append">
                    ...
                    <button class="btn btn-primary" onclick="buscar(document.getElementById('searchInput').value)">
                        <!-- Crear un icono SVG para el botón -->
...
<script>
    ...
    function buscar(codigo) {
        ...
        if (patron.test(codigo)) {
            // Si el código coincide, redirigir a la página del portatil
